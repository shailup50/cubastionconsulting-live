...
export async function generateMetadata(): Promise<Metadata> {
  const id = "5"; // Mapping Contact Us to 5 in pages-meta
  ...
  return {
    ...
    openGraph: {
      ...
      description: data?.MetaDescriptions || "",
      images: [
        { url: "/OGImage/cubastion.jpg", width: 1200, height: 630, alt: "Contact Us" },
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: `${CANONICAL_BASE}/contact-us`,
    },
    icons: {
...
export default async function ContactUs() {
  const id = "4"; // Keeping content fetch as is since it's "Static" data
