export const pathOverrides: Record<string, Record<string, Record<string, unknown>>> = {
  "/api/v1/auth/login": {
    post: {
      summary: "Admin login",
      description:
  ...
  "/api/v1/contact-tech-co-founder": {
    get: {
      tags: ["Leads"],
      summary: "List tech co-founder contact submissions",
      description:
        "Returns all submissions from the startup services forms (`contact_tech_co_founder` table), newest first. Intended for admin use.",
      security: [{ bearerAuth: [] }],
      responses: {
        200: {
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  data: {
                    type: "array",
                    items: { $ref: "#/components/schemas/ContactTechCoFounder" },
                  },
                },
              },
            },
    ...
    post: {
      tags: ["Leads"],
      summary: "Submit tech co-founder contact form",
      description:
        "Public endpoint used by `/startup-services` hero and contact sections. Persists to `contact_tech_co_founder`. Send `idea` or `idea_description` for the idea text.",
      security: [],
      requestBody: {
        required: true,
        content: {
          "application/json": {
            schema: { $ref: "#/components/schemas/ContactTechCoFounderCreateRequest" },
          },
        },
      },
      responses: {
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  status: { type: "boolean", example: true },
                  message: { type: "string" },
                  data: { $ref: "#/components/schemas/ContactTechCoFounder" },
                },
              },
            },
          },
  ...
  "/api/v1/contact-tech-co-founder/{id}": {
    get: {
      tags: ["Leads"],
      summary: "Get tech co-founder submission by ID",
      security: [{ bearerAuth: [] }],
      parameters: [
        {
          name: "id",
    ...
    delete: {
      tags: ["Leads"],
      summary: "Delete tech co-founder submission",
      description: "Removes a row from `contact_tech_co_founder` by ID.",
      security: [{ bearerAuth: [] }],
      parameters: [
        {
          name: "id",
