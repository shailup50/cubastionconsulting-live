...
export const ContactForm = ({
  ...
  const handleSubmit = async (e) => {
    ...
    if (configurationProgress < totalQuestions) {
      setConfigError(
        `Please answer all questions (${configurationProgress}/${totalQuestions} completed)`,
      );
      return;
    }
  ...
  return (
    <>
          ...
          <div className="!bg-white !rounded-xl md:!rounded-2xl !shadow-2xl !max-w-md !w-full !p-6 md:!p-8 !transform !transition-all">
            <div className="!text-center">
              ...
              <p className="!text-sm md:!text-base !text-slate-600 !mb-5 md:!mb-6">
                Your estimated investments have been emailed to the given email
                address
              </p>
              <button
      ...
      <div className="!bg-gradient-to-br !from-slate-50 !to-blue-50 !rounded-xl !shadow-md !border !border-slate-200 !p-4 md:!p-5">
        <div className="!mb-4">
          <h2 className="!text-base md:!text-[18px] !font-bold !text-slate-900 !mb-1">
            Get Your Detailed Estimate
          </h2>
          <p className="!text-[12px] md:!text-[14px] !text-slate-600 !leading-tight">
            Submit your information to receive a comprehensive migration
        ...
        <form onSubmit={handleSubmit} className="!space-y-3 md:!space-y-4">
          <div className="!grid !grid-cols-1 md:!grid-cols-2 !gap-3 md:!gap-4">
            <div>
              ...
              <input
                ...
                className={`!w-full !px-3 !py-2.5 !text-[14px] !rounded-lg !border ${errors.name ? "!border-red-500 focus:!ring-red-500" : "!border-slate-300 focus:!ring-blue-500"} focus:!ring-2 focus:!outline-none !transition-all !min-h-[50px]`}
            ...
            <div>
              ...
              <input
                ...
                className={`!w-full !px-3 !py-2.5 !text-[14px] !rounded-lg !border ${errors.company ? "!border-red-500 focus:!ring-red-500" : "!border-slate-300 focus:!ring-blue-500"} focus:!ring-2 focus:!outline-none !transition-all !min-h-[50px]`}
            ...
            <div>
              ...
              <input
                ...
                className={`!w-full !px-3 !py-2.5 !text-[14px] !rounded-lg !border ${errors.designation ? "!border-red-500 focus:!ring-red-500" : "!border-slate-300 focus:!ring-blue-500"} focus:!ring-2 focus:!outline-none !transition-all !min-h-[50px]`}
            ...
            <div>
              ...
              <input
                ...
                className={`!w-full !px-3 !py-2.5 !text-[14px] !rounded-lg !border ${errors.email ? "!border-red-500 focus:!ring-red-500" : "!border-slate-300 focus:!ring-blue-500"} focus:!ring-2 focus:!outline-none !transition-all !min-h-[50px]`}
          ...
          <div className="!flex !flex-col sm:!flex-row sm:!items-center sm:!justify-between !gap-3 !pt-3 !border-t !border-slate-200">
            ...
            <button
              ...
              className={`btn  btn-btn !w-full sm:!w-auto !px-6 !py-2.5 !text-[14px] !rounded-lg !font-semibold !text-white !transition-all !min-h-[50px] ${isSubmitting ? "!bg-slate-400 !cursor-not-allowed" : "btn btn-btn hover:!from-blue-700 hover:!to-blue-800 active:!scale-95 !shadow-md hover:!shadow-lg"}`}
            >
