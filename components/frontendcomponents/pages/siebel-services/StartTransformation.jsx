      ...
      <div className="container">
        <div className="mx-auto  rounded-[18px] border border-[#dfe5f1] bg-white p-6! sm:p-8! md:p-10!">
          <div className="flex flex-col items-center text-center">
            <div className="mb-5! inline-flex items-center gap-2 rounded-full border border-primary-start bg-white px-3.5! py-1.5! text-[10px]! font-semibold! uppercase tracking-[0.12em] text-[#052559] sm:mb-6! sm:px-4! sm:py-2! sm:text-[11px]!">
