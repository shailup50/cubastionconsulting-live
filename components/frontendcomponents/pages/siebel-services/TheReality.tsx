...
interface TheRealityProps {
  data: any;
  id: string;
}

export const TheReality = ({ data, id }: TheRealityProps) => {
  if (!data) return null;
    ...
    <section className="py-10! md:py-16! bg-[#dfe5f1]" id={id}>
      ...
      >
        <motion.div className="max-w-[420px] lg:sticky lg:top-28" variants={staggerParent}>
          <motion.div
            className="mb-5! inline-flex items-center gap-2 rounded-full border border-primary-start bg-white px-4! py-2! text-[11px]! font-semibold! uppercase tracking-[0.14em] text-[#052559]"
            variants={fadeUp}
          >
