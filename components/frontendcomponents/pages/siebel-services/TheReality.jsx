            ...
            <div className="container">
                <div className="grid items-start gap-8 lg:grid-cols-[0.95fr_1.65fr] lg:gap-10 xl:gap-14">
                    <div className="max-w-[420px] lg:sticky lg:top-28">
                        <div className="mb-5! inline-flex items-center gap-2 rounded-full border border-[#052559] bg-white px-4! py-2! text-[11px]! font-semibold! uppercase tracking-[0.14em] text-[#052559]">
                            <FiAlertTriangle className="text-sm" />
                            <span>{data.title}</span>
                        </div>

                        <h2 className="leading-[1.08] text-[#123f52]">
                            {data.heading}
                        </h2>
                            ...
                            return (
                                ...
                                >
                                    <div className="flex h-full flex-col">
                                        <div className="mb-4! flex h-10 w-10 items-center justify-center rounded-full border border-[#052559] bg-[#dfe5f1] text-[#1d6178]">
                                            <Icon className="text-[18px]" />
                                        </div>

                                        <h3 className="md:max-w-[14ch] text-[18px]! leading-[1.18] text-[#123f52]">
                                            {item.title}
                                        </h3>
