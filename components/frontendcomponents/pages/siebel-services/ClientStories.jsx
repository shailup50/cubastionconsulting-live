    ...
    <section id={id} className="bg-[#f5f7fa] py-10! md:py-16!">
      <div className="container">
        <div className="mx-auto text-center">
          ...
          <FaQuoteLeft className="text-xs sm:text-sm" /> <span> {data.title}</span>
          </div>
                  ...
                  <article className="h-full rounded-[20px] border border-[#052559] bg-white p-6! shadow-[0_10px_24px_rgba(17,24,39,0.06)]">
                    <div className="flex gap-2 text-[#f0a126]">
                      {Array.from({ length: 5 }).map((_, idx) => (
                        <FaStar
                          key={idx}
                          className={idx < item.rating ? "" : "text-[#d8d1c1]"}
                        />
                      ))}
                    </div>

                    <p className="mt-4! text-left text-[14px]! leading-6 text-[#000000b2]">
                      {item.quote}
                    </p>
                    ...
                    <div className="mt-5! flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <h4 className="text-[14px]! font-semibold! leading-[1.2] text-[#14546a]">
                          {item.customerName}
                        </h4>
                        <p className="text-[13px]! leading-[1.2] text-[#5b6870]">
                          {item.customerTitle}
                        </p>
                      </div>
                    </div>
