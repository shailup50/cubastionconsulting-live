...
export default function AboutUsPage({ initialHomeData = null, initialAboutData = null }: any) {
  const dispatch = useDispatch<any>();
  const { homeData: reduxHomeData, loading } = useSelector((state: any) => state.home);
  const { aboutData: reduxAboutData, aboutLoading } = useSelector((state: any) => state.about);
