...
export default function VisionSec({ data, id }: any) {
    if (!data) return null;
    ...
    const renderVisionCol = (vision: any) => (
                    ...
                    <div className="vision_wrapper">
                        {
                            isMobile ? (
                                ...
                                <>
                                    {data.visionData.map((item: any) => renderVisionCol(item))}
                                </>
                            )
                        }
                    </div>
